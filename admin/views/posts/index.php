          ...
          <div class="col-md-8">
            ...
            ?>
                  <tr>
                    ...
                    <td><a href="view.php?id=<?php echo $posts[$i]['id'] ?>">View</a> |
                        <a href="edit.php?id=<?php echo $posts[$i]['id'] ?>">Edit</a> |
                        <a href="delete.php?id=<?php echo $posts[$i]['id'] ?>" onclick="return confirm('Are you sure you want to delete this post.?');">Delete </a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
